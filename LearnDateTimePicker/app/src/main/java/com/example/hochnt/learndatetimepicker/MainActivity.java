package com.example.hochnt.learndatetimepicker;
...
public class MainActivity extends AppCompatActivity {
    ...
    Calendar calendar = Calendar.getInstance();//lay ngay gio hien tai
    ...
    private void xuLyHienThiDatePicker() {
        DatePickerDialog.OnDateSetListener callBack = new DatePickerDialog.OnDateSetListener() {
            @Override
            public void onDateSet(DatePicker datePicker, int i, int i1, int i2) {//yer month day
                calendar.set(Calendar.YEAR,i);//lay thoi gian sau khi chon lich
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(
                MainActivity.this,
                callBack,//lang nghe su thay doi cua khach hang
                calendar.get(Calendar.YEAR),
                calendar.get(Calendar.MONTH),
                calendar.get(Calendar.DAY_OF_MONTH)
        );

        datePickerDialog.show();//hien thi cua so datepickerdialog len
    }
